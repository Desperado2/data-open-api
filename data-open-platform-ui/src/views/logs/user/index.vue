  ...
  <div class="app-container">
    <el-row>
      <el-col :span="24"><div class="filter-container">
        <el-input v-model="queryBody.name" placeholder="API名称" style="width: 200px;" class="filter-item" />
...
import { listByUser } from '@/api/log-api'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      listByUser(this.queryBody).then(response => {
