...
import com.github.desperado2.data.open.api.datasource.manage.datasource.MySQLDataSource;
...
public class MySQLDriver extends JdbcDriver{
    ...
    public DataSourceDialect factory(DataSourceConfig config) throws Exception {
        return new MySQLDataSource(config.getCode(),super.getDataSource(config));
    }
}
