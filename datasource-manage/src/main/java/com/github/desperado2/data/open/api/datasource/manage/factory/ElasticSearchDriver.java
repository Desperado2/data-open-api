...
import com.github.desperado2.data.open.api.datasource.manage.datasource.ElasticSearchDataSource;
...
import com.github.desperado2.data.open.api.datasource.manage.utils.ElasticSearchUtils;
...
public class ElasticSearchDriver extends JdbcDriver{
    ...
    public DataSourceDialect factory(DataSourceConfig config) throws Exception {
        return new ElasticSearchDataSource(config.getCode(), ElasticSearchUtils.getRestClientTransport(config));
    }
}
