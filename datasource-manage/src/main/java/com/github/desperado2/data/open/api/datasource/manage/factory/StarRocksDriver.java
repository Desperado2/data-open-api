...
import com.github.desperado2.data.open.api.datasource.manage.datasource.StarRocksDataSource;
 ...
 **/
@Component
public class StarRocksDriver extends JdbcDriver{
    @Override
    ...
    public DataSourceDialect factory(DataSourceConfig config) throws Exception {
        return new StarRocksDataSource(config.getCode(),super.getDataSource(config));
    }
}
