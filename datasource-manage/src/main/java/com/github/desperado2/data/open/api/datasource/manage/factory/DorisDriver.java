...
import com.github.desperado2.data.open.api.datasource.manage.datasource.DorisDataSource;
 ...
 **/
@Component
public class DorisDriver extends JdbcDriver{
    @Override
    ...
    public DataSourceDialect factory(DataSourceConfig config) throws Exception {
        return new DorisDataSource(config.getCode(),super.getDataSource(config));
    }
}
