...
public class IndexOpenApiResponseModel {
    ...
    @ApiModelProperty("地址前置")
    private String apiAddressPrefix;

    private List<OpenApiResponseRequestModel> publicResponseModel;
    ...
    public String getApiAddressPrefix() {
        return apiAddressPrefix;
    }

    public void setApiAddressPrefix(String apiAddressPrefix) {
        this.apiAddressPrefix = apiAddressPrefix;
    }

    public List<OpenApiResponseRequestModel> getPublicResponseModel() {
        return publicResponseModel;
    }

    public void setPublicResponseModel(List<OpenApiResponseRequestModel> publicResponseModel) {
        this.publicResponseModel = publicResponseModel;
    }
