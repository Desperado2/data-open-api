...
public class DefaultGeneralCache implements IGeneralCache {

    private final static Logger log = LoggerFactory.getLogger(DefaultGeneralCache.class);
    ...
    public String get(String cacheKey) {
        return this.cacheMap.get(cacheKey).toString();
    }
